...
def initialize_logger(outputdir, logger):
    ...
    handler = logging.FileHandler(os.path.join(outputdir, "ssh_error.log"),"a", encoding=None, delay="true")
    ...
    handler = logging.FileHandler(os.path.join(outputdir, "ssh_debug.log"),"a")
